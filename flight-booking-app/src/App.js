    ...
    <Router>
      <div className="App">
          ...
          <nav>
            <ul>
              ...
              {loggedIn ? (
                <>
                  <li>
                    <Link to="/flights">Flight Selection</Link>
                  </li>
                  <li>
                    <Link to="/locations">Location Selection</Link>
                  </li>
                  <li>
        ...
        <Switch>
          ...
          <PrivateRoute path="/flights" component={FlightSelection} />
          <PrivateRoute path="/locations" component={LocationSelection} />
...
function FlightSelection() {
  return <h2>Flight Selection Page</h2>;
}

function LocationSelection() {
  return <h2>Location Selection Page</h2>;
}
